...
public class TodoWifiPeriodicReplicationReceiver extends
    WifiPeriodicReplicationReceiver<TodoReplicationService> {
    public TodoWifiPeriodicReplicationReceiver() {
