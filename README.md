...
dependencies {
    // Other dependencies
    compile group: 'com.cloudant', name: 'cloudant-sync-datastore-core', version:'0.12.2'
    // include this if you're targeting Android
    compile group: 'com.cloudant', name: 'cloudant-sync-datastore-android', version:'0.12.2'
    // include this if you're targeting Java SE
    compile group: 'com.cloudant', name: 'cloudant-sync-datastore-javase', version:'0.12.2'
}
```
