...
dependencies {
    ...
    compile group: 'com.cloudant', name: 'cloudant-sync-datastore-android', version:'0.12.3'
    ...
    compile group: 'com.cloudant', name: 'cloudant-sync-datastore-android-encryption', version:'0.12.3'
