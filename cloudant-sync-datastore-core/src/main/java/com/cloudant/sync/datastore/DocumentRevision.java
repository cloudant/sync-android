...
public class DocumentRevision implements Comparable<DocumentRevision> {
    ...
    DocumentRevision(String docId, String revId, DocumentBody body) {
        this(docId, revId, body, null);

    }

    DocumentRevision(String docId, String revId, DocumentBody body, DocumentRevisionOptions options) {
        this.id = docId;
        this.revision = revId;
        this.body = body;
