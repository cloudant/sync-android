 ...
 *  within this class using {@link MockSQLOnlyQuery}
 ...
 *  {@link MockMatcherQuery} which in turn
...
public class QueryCoveringIndexesTest extends AbstractQueryTestBase {
    ...
    public void setUp() throws Exception{
        ...
        if (testType.equals(SQL_ONLY_EXECUTION)) {
            idxMgr = new MockSQLOnlyQuery(im);
    ...
    public void returnsDocForQueryWithBool() throws Exception {
        ...
        ds.create(rev);
        assertThat(idxMgr.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("name"), new FieldSort("age"), new FieldSort("married")), "married").indexName, is("married"));
    ...
    public void returnsDocForQueryAgainstIndexWithSpecialChar() throws Exception {
        ...
        rev.setBody(DocumentBodyFactory.create(bodyMap));
        ds.create(rev);
        assertThat(idxMgr.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("name"), new FieldSort("age")), "basic index").indexName, is
                ("basic index"));
    ...
    public void canQueryForNonAsciiValues() throws Exception {
        ...
        assertThat(idxMgr.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("name")), "nonascii").indexName, is("nonascii"));
        // query - { "name" : { "$eq" : "اسم" } }
        Map<String, Object> op = new HashMap<String, Object>();
        op.put("$eq", "اسم");
        Map<String, Object> query = new HashMap<String, Object>();
    ...
    public void canQueryUsingFieldsWithOddNames() throws Exception {
        setUpNonAsciiQueryData();
        assertThat(idxMgr.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("اسم"), new FieldSort("datatype"), new FieldSort("age")), "nonascii").indexName,
                is("nonascii"));
