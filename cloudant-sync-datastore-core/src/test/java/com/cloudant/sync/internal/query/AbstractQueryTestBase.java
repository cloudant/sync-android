...
public abstract class AbstractQueryTestBase {
    ...
    public void setUpBasicQueryData() throws Exception {
        ...
        assertThat(im.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("name"), new FieldSort("age")), "basic").indexName, is("basic"));
        assertThat(im.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("name"), new FieldSort("pet")), "pet").indexName, is("pet"));
    }
    ...
    public void setUpDottedQueryData() throws Exception {
        ...
        assertThat(im.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("age"), new FieldSort("pet.name"), new FieldSort("pet.species")), "pet").indexName,
                is("pet"));
        assertThat(im.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("name"), new FieldSort("pet.name.first")), "firstname").indexName,
                is("firstname"));
    }
    ...
    public void setUpOrQueryData() throws Exception {
        ...
        assertThat(im.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("age"), new FieldSort("pet"), new FieldSort("name")), "basic").indexName,
                is("basic"));
        assertThat(im.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("age"), new FieldSort("pet.name"), new FieldSort("pet.species")), "pet").indexName,
                is("pet"));
        assertThat(im.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("age"), new FieldSort("pet.name.first")), "firstname").indexName,
                is("firstname"));
    }
    ...
    public void setUpArrayIndexingData() throws Exception {
        ...
        assertThat(im.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("name"), new FieldSort("pet"), new FieldSort("age")), "pet").indexName,
                is("pet"));
    }
    ...
    public void setUpNumericOperationsQueryData() throws Exception {
        ...
        assertThat(im.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("name"), new FieldSort("score")), "name_score").indexName,
                                    is("name_score"));
    }
    ...
    public void setUpLargeResultSetQueryData() throws Exception {
       for (int i = 0; i < 150; i++) {
        ...
        assertThat(im.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("large_field"), new FieldSort("idx")), "large").indexName,
                is("large"));
    }
    ...
    public void setUpSizeOperatorQueryData() throws Exception {
        ...
        assertThat(im.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("name"), new FieldSort("pet"), new FieldSort("age")), "basic").indexName, is("basic"));
    }
    ...
    public void setUpSortingQueryData() throws Exception {
        ...
        assertThat(im.createJsonIndex(Arrays.<FieldSort>asList(new FieldSort("name"), new FieldSort("pet"), new FieldSort("age"), new FieldSort("same")), "pet").indexName,
                is("pet"));
    }
