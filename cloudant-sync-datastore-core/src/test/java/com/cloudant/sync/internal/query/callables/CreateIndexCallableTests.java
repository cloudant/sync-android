...
/**
 * Created by rhys on 10/01/2017.
 */
public class CreateIndexCallableTests {
    ...
    public void returnsIndexSettingsAsAString() {
        ...
        assertThat(CreateIndexCallable.settingsAsJSON(index), is("{\"tokenize\":\"simple\"}"));
    }
    ...
    public void returnsNullIndexSettingsAsAString() {
        ...
        assertThat(CreateIndexCallable.settingsAsJSON(index), is("{}"));
    }
}
