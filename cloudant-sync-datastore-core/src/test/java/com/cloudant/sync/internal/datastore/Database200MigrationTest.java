...
import com.cloudant.sync.internal.datastore.DatastoreConstants;
...
public class Database200MigrationTest {
    ...
    public void testDatabaseWithComplexTree() throws Exception {
        ...
        Assert.assertThat(getRevs(), containsInAnyOrder("1-abc", rootRevision.getRevision()));
    ...
    public void testDatabaseWithForest() throws Exception {
        ...
        Assert.assertThat(getRevs(), containsInAnyOrder(rootRevision.getRevision(), rev.getRevision()));
    }
