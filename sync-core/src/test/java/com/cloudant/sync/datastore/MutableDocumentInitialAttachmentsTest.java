...
public class MutableDocumentInitialAttachmentsTest extends BasicDatastoreTestBase{
    ...
    @Test
    public void removeAttachment() throws ConflictException, IOException {
        MutableDocumentRevision update = saved.mutableCopy();
    ...
    @Test
    public void removeAllAttachmentsNull() throws ConflictException, IOException {
        MutableDocumentRevision update = saved.mutableCopy();
    ...
    // empty hash
    @Test
    public void removeAllAttachmentsEmpty() throws ConflictException, IOException {
        MutableDocumentRevision update = saved.mutableCopy();
    ...
    @Test
    public void copyAttachment() throws ConflictException, IOException {
        MutableDocumentRevision update = saved.mutableCopy();
        ...
        DocumentRevision copied = datastore.createDocumentFromRevision(copy);
    ...
    @Test
    public void removeAllAttachmentsNullConflictTest() throws ConflictException, IOException {
        ...
        DocumentRevision retrieved = datastore.getDocument(saved.getId());
    ...
    @Test
    public void createDocumentsWithAutoGeneratedId() throws ConflictException, IOException {
        MutableDocumentRevision rev1 = new MutableDocumentRevision();
        rev1.body = bodyOne;
        DocumentRevision doc1 = datastore.createDocumentFromRevision(rev1);
        Assert.assertNotNull("Document is null", doc1);

        MutableDocumentRevision rev2 = new MutableDocumentRevision();
        rev2.body = bodyOne;
        DocumentRevision doc2 = datastore.createDocumentFromRevision(rev2);
